...
const SignUpView = () => {
  ...
  return (
    <div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8">
              <div className="flex flex-col gap-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="text" placeholder="Robert Antwi" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="email" placeholder="meetai@gmail.com" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <Button type="submit" className="w-full" disabled={loading}>{loading ? <Spinner /> : "Sign up"}</Button>
      ...
      <div className="mt-6 text-muted-foreground *:[a]:hover:text-primary text-center text-xs
